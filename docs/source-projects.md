...
| `ce-doc-review` and plan confidence checks | `d090bde0ff1bbc33ec3c3b2049cb4687e9d76532` | Medium-priority adaptation candidate | It complements `product-capability`, `grill-me`, and `effective-interact` by adding persona-based review of plans and requirements. Install only after defining how this hub wants plan artifacts and review outputs to persist. |
