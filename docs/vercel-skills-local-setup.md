...
| Path | Purpose |
|---|---|
| `.codex/skills/find-skills/SKILL.md` | Vercel's skill for discovering and installing skills from the open skills ecosystem. |
| `.codex/skills/find-skills/agents/openai.yaml` | Codex UI metadata added locally. |
| `.codex/skills/vercel-react-best-practices/` | Vercel React and Next.js performance guidance. |
| `.codex/skills/web-design-guidelines/` | Vercel Web Interface Guidelines audit skill, adapted to Codex web/browser tooling. |
| `.codex/skills/vercel-composition-patterns/` | React component composition and API design patterns. |
| `.codex/skills/vercel-react-view-transitions/` | React View Transition API and Next.js transition guidance. |

## Notes

- Vercel's CLI documents Codex project-level installs at `.codex/skills/`.
