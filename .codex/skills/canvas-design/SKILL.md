...
- **Leave creative space**: Remain specific about the aesthetic direction, but concise enough that the next Codex agent has room to make interpretive choices also at a extremely high level of craftmanship.
...
- **ARTISTIC FREEDOM**: The next Codex agent interprets the philosophy visually - provide creative room
