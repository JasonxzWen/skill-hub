...
| **Harness subagent tool** | In-process subagent spawning (`spawn_agent` in Codex, equivalent subagent mechanisms in other harnesses) | Programmatic parallelism within a session |
