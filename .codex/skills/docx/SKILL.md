...
**Use the Codex native file-editing tools directly for string replacement. Do not write Python scripts.** Scripts introduce unnecessary complexity. The Codex native file-editing tools shows exactly what is being replaced.
