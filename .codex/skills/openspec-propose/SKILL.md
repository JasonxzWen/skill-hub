...
When ready to implement, run ask Codex to use $openspec-apply-change
...
- Prompt: "Run `ask Codex to use $openspec-apply-change` or ask me to implement to start working on the tasks."
